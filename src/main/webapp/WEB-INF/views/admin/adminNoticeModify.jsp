    ...
    <div id="wrapper">
		...
		<div class="Sn-insert-wrapper">
			<div class="Sn-insert-section">
				...
				<form method="POST" action="${contextPath}/admin/update/N/${boardNo}" id="insertform" enctype="multipart/form-data">
					<div class="Sn-form">
					...
					<div class="Sn-btn-group">
						...
						<button type="reset" class="Sn-cancel-btn" onclick="window.location.href='${contextPath}/admin/detail/N/${b.boardNo }'">취소</button>
					</div>
				</form>
				</div>
			</div>
