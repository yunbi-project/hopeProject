...
<link rel="stylesheet" href="../resources/style/css/sangjun.css/SreviewList.css">
</head>
<body>
                        ...
                        <div class="Sn-row">
                            <div class="Sn-article">
                                <div class="Sn-image-container">
                                    <div class="Sn-notice-image" ><img src="../resources/images/board/HOPE_logo.png"></div>
                                </div>
                ...
                <div class="Sn-section" >
                    ...
                    <div class="Sn-list" >
                        <div class="Sn-row">
                            <div class="Sn-article">
                                <div class="Sn-image-container">
                                    <div class="Sn-notice-image" ><img src="/css/images/2_WOS (1).jpg"></div>
                                </div>
                                <div class="Sn-notice-frame">
                                    <div class="Sn-notie-title">글제목</div>
                                    <p class="Sn-notice-date" >작성날짜</p>
                ...
                <div class="Sn-section" >
                    ...
                    <div class="Sn-list" >
                        <div class="Sn-row">
                            <div class="Sn-article">
                                <div class="Sn-image-container">
                                    <div class="Sn-notice-image" ><img src="/css/images/chunsickbackground.png"></div>
                                </div>
                                <div class="Sn-notice-frame">
                                    <div class="Sn-notie-title">글제목</div>
                                    <p class="Sn-notice-date" >작성날짜</p>
                ...
                <div class="Sn-section" >
                    ...
                    <div class="Sn-list" >
                        <div class="Sn-row">
                            <div class="Sn-article">
                                <div class="Sn-image-container">
                                    <div class="Sn-notice-image" ><img src="/css/images/user0.jpg"></div>
                                </div>
                                <div class="Sn-notice-frame">
                                    <div class="Sn-notie-title">글제목</div>
                                    <p class="Sn-notice-date" >작성날짜</p>
                ...
                <div class="Sn-section" >
                    ...
                    <div class="Sn-list" >
                        <div class="Sn-row">
                            <div class="Sn-article">
                                <div class="Sn-image-container">
                                    <div class="Sn-notice-image" ><img src="/css/images/user1.jpg"></div>
                                </div>
                                <div class="Sn-notice-frame">
                                    <div class="Sn-notie-title">글제목</div>
                                    <p class="Sn-notice-date" >작성날짜</p>
